...
[/block]
The top left tab of the interface provides access to the registration stats by Member (provider). 
[block:image]
{
  "images": [
    {
...
[/block]
By clicking the name of a Provider (Member), you can display all the Data Centers (Users) working with the selected Member. Every filter used will appear on the top left of the page. They can be removed by clicking the red cross button on their left side.
[block:image]
{
  "images": [
    {
