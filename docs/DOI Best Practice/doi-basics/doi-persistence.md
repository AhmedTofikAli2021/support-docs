...
[What is a DOI](https://www.doi.org/the-identifier/what-is-a-doi/)<br />[The DOI handbook](https://www.doi.org/doi-handbook/HTML/index.html)<br />[DOI Resolution Protocol Specification](https://www.dona.net/sites/default/files/2022-06/DO-IRPV3.0--2022-06-30.pdf)<br />[Prefixes](https://support.datacite.org/docs/prefixes)
...
- **Change the state of the erroneous DOI from Findable to Registered state.** This means the DOI will not be found in DataCite Commons search results or Public API queries. Registered DOIs will continue to resolve.<br />Learn more about [DOI states](doc:doi-states).
