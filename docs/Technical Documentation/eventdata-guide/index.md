---
title: DataCite Event Data Guide
excerpt: ''
deprecated: false
hidden: false
metadata:
...
With these three categories there are 8 (2 x 2 x 2) relation types for usage events (see [relation-type-id](doc:eventdata-apis#section-relation-type-id) below).
