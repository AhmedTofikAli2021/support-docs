...
Just like with our production services, there are two levels of credentials for the test system: a Client account allows you to create and manage DOIs, and a Provider account allows you to create and manage Clients. 
[block:api-header]
{
  "title": "Request a test account"
}
[/block]
DataCite staff will create test accounts for Providers during onboarding. The Provider will then have the authority and responsibility for creating test accounts for their Clients. 

If you are a Client of a DataCite Provider, please contact your Provider to request a test account. 
...
[/block]
After your test account has been created, either by your Provider or by DataCite staff, you will receive an automated email from the test instance of DOI Fabrica containing a *Generate password* link.
[block:image]
{
  "images": [
    {
