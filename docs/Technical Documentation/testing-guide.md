...
* [Create a client in Fabrica Test](doc:create-a-client-in-fabrica-test)
[block:api-header]
{
...
[/block]
Current DataCite Providers and Clients can have test accounts, as can potential new members.