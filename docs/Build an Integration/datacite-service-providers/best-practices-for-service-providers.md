---
title: Best Practices for Registered Service Providers
excerpt: Version 2.1, May 2024
deprecated: false
hidden: false
metadata:
  title: ''
...
next:
  description: ''
---
Participants in the [DataCite Registered Service Providers program](doc:datacite-service-providers) should make best efforts to adhere to the best practices outlined on our support site. The key best practices are linked and summarized below:
...
DataCite Registered Service Providers are also encouraged to:

- Advise users to [add repository software information to the Settings section of their DataCite repository account](doc:fabrica-settings#software-optional).
- Advise users who operate data repositories to submit their repositories to the Registry of Research Data Repositories [re3data](https://www.re3data.org/), using the form at <https://www.re3data.org/suggest>, and [add their re3data record to the Settings section of their DataCite repository account](doc:fabrica-settings#re3data-record-optional).
- Support the [Make Data Count](https://makedatacount.org/) initiative by gathering and submitting dataset usage metrics compliant with the [COUNTER Code of Practice for Research Data](https://www.projectcounter.org/code-of-practice-rd-sections/foreword/).
...
See [Glossary](https://support.datacite.org/docs/glossary-of-commonly-used-terms) for more commonly used terms in DataCite documentation.