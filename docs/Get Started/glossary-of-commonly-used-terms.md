...
![](https://files.readme.io/8649f6d-Screenshot_2023-02-20_at_13.41.39.png "Screenshot 2023-02-20 at 13.41.39.png")

Further reading:  
[Persistent identifiers - Digital Preservation Handbook](https://www.dpconline.org/handbook/technical-solutions-and-tools/persistent-identifiers)
...
Further reading:  
UNC Library - [Metadata for Data Management: A Tutorial: Definition](https://guides.lib.unc.edu/metadata/definition)  
[CODATA glossary](https://codata.org/rdm-terminology/metadata/)  
[ARDC guide](https://doi.org/10.5281/zenodo.6459831)  
Dataversity - [A brief history of metadata](https://www.dataversity.net/a-brief-history-of-metadata/)  
NISO - [Understanding metadata](https://groups.niso.org/apps/group_public/download.php/17446/Understanding%20Metadata.pdf)  
DublinCore - [Creating metadata](https://www.dublincore.org/resources/userguide/creating_metadata/)  
Getty Blog- [Metadata specialists share their challenges and defeats and triumphs](http://blogs.getty.edu/iris/metadata-specialists-share-their-challenges-defeats-and-triumphs/)

## Metadata Schema

A metadata schema is a list of relevant criteria to help identify something. Some examples of metadata properties (also known as elements or fields) include:

Title  
Creator  
Subject

DataCite has its own metadata schema that is domain agnostic. The [DataCite metadata schema](http://schema.datacite.org/) defines a set of metadata properties for DataCite DOIs. Each property in the schema is designed to help DataCite members share information about the research outputs they are sharing. There are six required properties. The rest of the properties are recommended or optional.
...
Further reading  
[Best practices for DOI landing pages](doc:landing-pages)  
