...
link:
  new_tab: false
  url: https://support.datacite.org/docs/connecting-to-works
metadata:
  title: ''
  description: ''
  robots: index
...
This information can now be exposed via [Event Data](doc:eventdata-guide) in [DataCite Commons](doc:datacite-commons) ](doc:datacite-search-user-documentation) and via the [Data Metrics Badge](doc:displaying-usage-and-citations-in-your-repository).
