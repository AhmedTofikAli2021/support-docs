---
title: Connecting Research Outputs
excerpt: ''
deprecated: false
hidden: true
link:
  new_tab: false
  url: https://support.datacite.org/docs/making-and-using-connection-metadata
metadata:
  title: ''
  description: ''
  robots: index
...
To find out more about how to implement this in practice when sending relatedIdentifiers to DataCite in the DOI metadata see [relationType for citation](relationtype_for_citation). 
[block:callout]
{
  "type": "info",
