...
A Member wishing transfer all DOIs and the prefix from one Repository to another should submit a request to DataCite Support ([support@datacite.org](mailto:support@datacite.org)) including all of the following information:
...
Individual DOIs can be manually transferred in Fabrica by [Direct Members ](doc:fabrica-transfer-dois)(between their own Repositories), [Consortium Leads](transfer-dois-between-repositories-consortium-orgs) (between their Consortium Organizations' Repositories), and [Consortium Organizations](transfer-dois-between-repositories-consortium-orgs) (between their own Repositories). 

If you need to transfer a large subset of DOIs, contact [support@datacite.org](mailto:support@datacite.org) for assistance.