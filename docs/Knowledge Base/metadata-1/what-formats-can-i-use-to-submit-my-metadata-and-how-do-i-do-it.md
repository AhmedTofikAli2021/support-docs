---
title: What formats can I use to submit metadata?
excerpt: ''
deprecated: false
hidden: false
metadata:
...
- [Create a DOI using the File Upload](doc:fabrica-doi-file-upload)