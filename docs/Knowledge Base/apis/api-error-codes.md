---
title: What are the API error codes?
excerpt: ''
deprecated: false
hidden: false
metadata:
...
| 409        | The resource already exists                                                             | Check whether the DOI has already been registered: <https://api.datacite.org/dois/YOURDOINAME>                                                                      |
...
| 429        | Your request has been rate limited. See <https://support.datacite.org/docs/rate-limit>. | Authenticate your or identify your request to receive a higher rate limit. Otherwise, reduce your request rate. See [DataCite API Rate Limits](doc:rate-limit).     |
