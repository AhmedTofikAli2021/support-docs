...
GET /dois
$ curl [https://api.datacite.org/dois/10.6084/m9.figshare.21545982](https://api.datacite.org/dois/10.6084/m9.figshare.21545982)

You can also run a query to retrieve a list of DOIs, for example, search for all DOIs with a specific “publisher”.

GET /dois
$ curl [https://api.datacite.org/dois?query=publisher:DataCite](https://api.datacite.org/dois?query=publisher:DataCite)
[block:callout]
{
  "type": "info",
  "body": "To run a GET request use curl from the command line, an application like [Postman](https://www.postman.com/), or simply paste into your browser."
}
[/block]
