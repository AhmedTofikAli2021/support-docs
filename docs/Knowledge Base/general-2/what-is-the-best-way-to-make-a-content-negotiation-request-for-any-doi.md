...
$  curl -LH "Accept: application/vnd.citationstyles.csl+json;q=1.0" [https://doi.org/10.1021/acs.joc.0c00770](https://doi.org/10.1021/acs.joc.0c00770)

DataCite's content negotiation service is available at [https://data.datacite.org](https://data.datacite.org) and only supports DataCite DOIs.