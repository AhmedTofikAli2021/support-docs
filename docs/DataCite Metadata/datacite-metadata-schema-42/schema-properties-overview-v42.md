---
title: DataCite Metadata Schema v4.2 Properties Overview
excerpt: ''
deprecated: false
hidden: true
metadata:
...
The properties of the DataCite Metadata Schema are presented in this section. More detailed descriptions of the properties, and their related sub-properties, are provided in [DataCite Schema Mandatory Properties](doc:schema-mandatory-properties-v42) and [DataCite Schema Recommended and Optional Metadata](doc:schema-optional-properties-v42). 
...
The [DataCite Schema Mandatory Properties](doc:schema-mandatory-properties-v42) provides a detailed description of the mandatory properties, which *must* be supplied with any initial metadata submission to DataCite, together with their sub-properties. **If one of the required properties is unavailable** , please use one of the standard (machine-recognizable) codes listed in [Standard Values for Unknown Information](doc:schema-values-unknown-information-v42). In [DataCite Schema Recommended and Optional Properties](doc:schema-optional-properties-v42), the Recommended and Optional properties are described in detail. For an example of how to make a submission in XML format, please see the [XML Metadata Examples](doc:schema-metadata-examples-v42) or the [DataCite Metadata Schema website](http://schema.datacite.org/).
...
[/block]
Examples for various resource types and special cases can be found in [XML Metadata Examples](doc:metadata-examples).
[block:api-header]
{
  "type": "basic",
  "title": "XML Schema"
...
[/block]
The XML Schema is available here: http://schema.datacite.org/meta/kernel-4.1/metadata.xsd
