...
Information about parts and versions is exposed in the “relationships” section of the DataCite REST API. This information is also available via the [DataCite GraphQL API](doc:datacite-graphql-api-guide).
...
[block:parameters]
{
  "data": {
    ...
    "16-2": "B is new version of A",
    "16-3": "n/a",
    "17-0": "IsPreviousVersionOf",
    "17-1": "A is previous version of B",
    "17-2": "B is previous version of A",
    "17-3": "n/a",
    "18-0": "IsDocumentedBy",
