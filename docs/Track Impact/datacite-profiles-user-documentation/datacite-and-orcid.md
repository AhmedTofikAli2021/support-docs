...
Start by logging in to your ORCID account on <https://orcid.org> and then scroll down to the "Works" section. Click the “Add” button and a drop down list of options will appear. Select Search & Link and then scroll down to select “DataCite”.
