...
> 🚧 
> 
> The Data Metrics Badge is no longer supported. For more information on retrieving usage and citation information, see the documentation on [Views and Downloads](doc:views-and-downloads) and [Citations and References](doc:citations-and-references).
...
> 👍 
> 
> This work was supported by the Belmont Forum as an output of the PARSEC project, with funds specifically provided by the National Science Foundation under Grant Number 1929464
