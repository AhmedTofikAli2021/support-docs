...
Data citation information is then made openly available via Event Data so that anyone interested can find and use this information. Read more about Event Data [here](doc:eventdata-guide)