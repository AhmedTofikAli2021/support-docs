...
Citations and references are types of linking events between research outputs. Linking events are relations between two DOIs, or a DOI and a URL. For DataCite DOIs, these are described in DataCite metadata using the relatedIdentifier property. [Crossref uses a different method](https://www.crossref.org/documentation/reference-linking/data-and-software-citation-deposit-guide/) for capturing linking events in the metadata. 
...
For more information, see [Displaying Usage and Citations in your Repository](doc:displaying-usage-and-citations-in-your-repository).
...
For more information, see the DataCite GraphQL API Guide: [DataCite GraphQL API Guide](doc:datacite-graphql-api-guide)
...
> 🚧 
> 
> DataCite services that contain citation data rely on an external service: [Crossref Event Data](https://www.crossref.org/services/event-data/). Because of this dependency, citation data is not available in DataCite test environments.