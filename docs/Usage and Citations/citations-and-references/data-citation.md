...
* [FORAGE: the hunt for existing data citations](https://www.youtube.com/watch?v=dy1Z4vGXHxo) (March 17, 2022)
* [EXPLORE: the need for an open classification system](https://www.youtube.com/watch?v=u-xMzA7sRTs) (April 7, 2022)
* [BEGIN: metadata for meaningful data metrics](https://www.youtube.com/watch?v=Qtpyp_mhx4A) (May 19, 2022)

### SCHOLIX: A Framework for Scholarly Link eXchange
The [Scholix initiative](http://www.scholix.org/) is a high level interoperability framework for exchanging information about the links between scholarly literature and data. It aims to build an open information ecosystem to understand systematically what data underpins literature and what literature references data.

DataCite Event Data implements a Scholix-compliant interface. To learn more about Scholix, see the [Scholix FAQ](http://www.scholix.org/faq).
