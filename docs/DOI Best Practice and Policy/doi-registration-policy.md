...
3. You can assign a DOI to multiple types of research outputs. The [DataCite Metadata Schema](https://schema.datacite.org) must be suitable for describing these items.
