---
title: DataCite Registered Service Providers
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Registered Service Providers are listed in our [Service Provider Listing](https://datacite.org/service-providers.html).
...
5. Do their best to adhere to the [DataCite Best Practices for Service Providers](doc:best-practices-for-service-providers)
...
7. Provide first-line support to their users, escalating to DataCite support ([support@datacite.org](mailto:support@datacite.org)) if necessary
8. Provide a designated contact email that DataCite staff can use to request assistance with troubleshooting member support issues and to inform the Service Provider about updates to DataCite services. This can be a group email address, e.g. [info@service.org](mailto:info@service.org)
...
- DataCite Registered Service Providers are expected to follow the [DataCite Best Practices for Service Providers](doc:best-practices-for-service-providers).

# Benefits of Service Provider Registration

Registered Service Providers are:

- Listed in the [DataCite Registered Service Provider Listing](https://datacite.org/service-providers.html)
...
- Invited to join quarterly calls where Service Providers can learn about and provide input on upcoming DataCite features/changes and discuss best practices with other Service Providers.

# Become a Registered Service Provider

1. Review the [DataCite Best Practices for Service Providers](doc:best-practices-for-service-providers) and ensure that you are following these best practices and that you meet the requirements listed above.
