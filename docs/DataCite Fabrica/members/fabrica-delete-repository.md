...
link:
  new_tab: false
  url: https://support.datacite.org/docs/fabrica-repositories#delete-a-repository
metadata:
  title: ''
  description: ''
  robots: index
next:
  description: ''
---
Direct Members can delete empty Repositories. If the Repository contains registered DOIs, the Direct Member must first [transfer the DOIs](doc:fabrica-transfer-dois) to another Repository.

Once remaining DOIs have been transferred, go to the _Repositories_ tab of the Direct Member dashboard. Select the Repository to go to the Repository dashboard.
