---
title: Create and Update DOIs with the DOI Form
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Repositories can access the DOI form through the "Create DOI" button, which appears on the left side of all tabs of the Repository dashboard.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/66fec78-Screenshot_2023-01-25_at_12.01.32.png",
        "Screenshot 2023-01-25 at 12.01.32.png",
        1364
      ],
      "align": "center",
      "sizing": "400px",
...
After filling in the form, click the "Create DOI" button at the bottom of the page. Your DOI will be saved and the DOI record page will be displayed.

For more information on creating DOIs in Fabrica, watch this short video: [Creating a DOI using the form in Fabrica](https://youtu.be/syBu-JKYA10)
...
In the upper left corner, click "Update DOI (Form)" to access the DOI Form.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/00c7407eb354eb3923a4e595019bed940712f6e66404668e740f21856163e773-Screenshot_2025-07-11_at_12.51.15.png",
...
> 🚧 Updating Schema 3 DOIs with the DOI Form
> 
> The DOI Form will always update the metadata schema to the latest version.
...
To auto-populate the Creator name, add an [ORCID iD](https://orcid.org/) or [ROR ID](http://www.ror.org/) or other name identifier in the Name Identifier field. The identifier must be entered as a URL, for example <https://orcid.org/0000-0002-1825-0097>. Using this method means the name fields will not be editable to avoid any accidental incorrect attribution. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bbe17fc59b33799af7a7b1c07d8308078e0f643da2e2bd05ffa466a301542fcd-Screenshot_2026-01-12_at_14.48.36.png",
...
##### SeriesInformation and Citations
...
> 
> Use [file upload](doc:fabrica-doi-file-upload) option to include any of these elements. Learn more about the [DataCite Metadata Schema](http://schema.datacite.org/).