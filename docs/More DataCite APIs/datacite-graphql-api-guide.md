...
next:
  description: ''
---
> ❗️ Upcoming DataCite GraphQL Deprecation
> 
> The DataCite GraphQL API will be deprecated in July 2027. Learn more here: [DataCite GraphQL Deprecation](doc:datacite-graphql-api-deprecation)
