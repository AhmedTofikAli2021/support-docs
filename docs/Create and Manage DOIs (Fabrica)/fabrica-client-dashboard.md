...
[/block]
The *Settings* tab contains the Client ID, re3data ID with related repository information, technical contact information and the allowed domains for DOI landing pages. Information on when the record was created and last updated is in the lower left-hand corner of the sidebar. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/021cc35-Screenshot_2019-04-26_at_13.43.54.png",
        "Screenshot 2019-04-26 at 13.43.54.png",
        1261,
        555,
        "#f2f6f7"
      ],
...
The *Prefixes* tab contains a list of all prefixes assigned to your Client account including the date they have been added. Your Provider will typically assign you at least one prefix to start with. If you require additional prefixes, please contact your Provider. 
[block:image]
{
  "images": [
    {
...
[/block]
The *DOIs* tab lists all the DOIs registered by the Client. Clients can view DOI information including author, version, publication year, publisher and licensing data. Clients can also use the search form to find an individual DOI. 
[block:image]
{
  "images": [
    {
