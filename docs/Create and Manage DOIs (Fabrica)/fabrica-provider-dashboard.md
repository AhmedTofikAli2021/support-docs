...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9bd1051-Screenshot_2019-04-26_at_14.58.49.png",
        "Screenshot 2019-04-26 at 14.58.49.png",
        1262,
        619,
        "#f9f9f9"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/41db02b-Screenshot_2019-04-26_at_15.00.35.png",
        "Screenshot 2019-04-26 at 15.00.35.png",
        1267,
        607,
        "#f9fbfb"
      ],
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3b8229c-Screenshot_2019-04-26_at_15.01.49.png",
        "Screenshot 2019-04-26 at 15.01.49.png",
        1261,
        633,
        "#fafcfb"
      ],
...
[/block]
The *DOI* tab lists all the DOIs registered by all Clients associated with a Provider. Providers can view DOI information including author, version, publication year and publisher. Providers can also use the search form to find an individual DOI.
[block:image]
{
  "images": [
    {
