...
{
  "type": "danger",
  "title": "Test Prefix retired June 1, 2019",
  "body": "The test prefix 10.5072 has been retired as of June 1, 2019. As of that date it will not be possible to use the test prefix to create new DOIs. Existing DOIs using the test prefix will gradually phase out over the month of June as their 30-day expirations occur."
}
[/block]
