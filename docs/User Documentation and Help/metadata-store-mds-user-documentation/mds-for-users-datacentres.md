...
[/block]
Once you preview a DOI entry, you can use Yellow pencil button on the bottom right of the first box to edit the dataset's DOI. You will see the same submission form you had when you [registered the dataset](doc:mds-for-users-datacentres#section-dataset-management-register-new-dataset). You will only have to update the DOI name, URL or metadata and save.
[block:callout]
{
  "type": "info",
