---
title: DataCite Metadata Schema v4.4 Properties Overview
excerpt: ''
deprecated: false
hidden: true
metadata:
...
The properties of the DataCite Metadata Schema are presented in this section. More detailed descriptions of the properties, and their related sub-properties, are provided in [DataCite Schema Mandatory Properties](doc:datacite-metadata-schema-v44-mandatory-properties) and [DataCite Schema Recommended and Optional Metadata](doc:datacite-metadata-schema-v44-recommended-and-optional-properties). 
...
[block:parameters]
{
  "data": {
    ...
    "12-2": "O",
    "13-0": "20",
    "13-1": "RelatedItem (with identifier, creator, title, publication year,\nvolume, issue, number, page, publisher, edition, and contributor\nsub-properties)",
    "13-2": "O"
  },
  "cols": 3,
  "rows": 14
...
[/block]
Examples for various resource types and special cases can be found in [XML Metadata Examples](doc:schema-metadata-examples-v44).
[block:api-header]
{
  "type": "basic",
  "title": "XML Schema"
