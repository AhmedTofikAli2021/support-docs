---
title: Create a Repository (old version)
excerpt: ''
deprecated: false
hidden: true
link:
  new_tab: false
  url: https://support.datacite.org/docs/fabrica-create-repository
metadata:
  title: ''
  description: ''
  robots: index
...
[block:callout]
{
  "type": "success",
  "title": "Prefixes",
  "body": "The assign prefix function is temporarily disabled until a new workflow is implemented. Once the Repository account is set up send an email to support@datacite.org to request a prefix."
}
[/block]
