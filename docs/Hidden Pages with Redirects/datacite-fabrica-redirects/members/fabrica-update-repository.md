...
To modify the Repository settings, go to the Settings tab in the Repository dashboard. Members will first need to select the Repository from their list of Repositories in order to view the appropriate Repository dashboard. Click the _Update Repository_ button on the top left. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ea12eb9-Screenshot_2024-05-09_at_11.59.35.png",
...
This field will only appear if the Repository Type **"Disciplinary"** has been selected. Add the discipline of the repository using the look-up from the OECD Fields of Science.
