---
title: Construct a Query to Search DOI Metadata
excerpt: ''
deprecated: false
hidden: false
metadata:
...
- The ["Filter using query string syntax" function of the DataCite Metadata Dashboard](doc:datacite-metadata-dashboard#navigation-and-filters)
...
Provide a date or date range to search the fields `created`, `updated`, and `registered`. For example:

- `updated:2022-04-01`
- `created:[2024-12-01 TO 2025-12-31]`
...
| created       | Creation date of the DOI record. (See [Dates](doc:queries#dates) for formatting.)      |
| registered    | Registration date of the DOI record. (See [Dates](doc:queries#dates)  for formatting.) |
| updated       | Last updated date of the DOI record. (See [Dates](doc:queries#dates)  for formatting.) |