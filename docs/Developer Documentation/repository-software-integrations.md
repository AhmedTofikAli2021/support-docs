...
link:
  new_tab: false
  url: https://support.datacite.org/docs/list-of-datacite-service-providers
metadata:
  title: ''
  description: ''
  robots: index
...
[block:callout]
{
  ...
  "body": "You will have to become a DataCite Provider or Client in order to assign DataCite DOIs to your datasets. Check what is the difference and how to become a member [here](doc:what-is-the-difference-between-members-and-users)!"
}
[/block]
