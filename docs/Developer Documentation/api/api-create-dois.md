...
next:
  description: ''
---
DOIs can be created using the `https://api.datacite.org/dois` endpoint. Only Repositories have the ability to create DOIs. This section of the guide will show you how to create first a Draft DOI and then a Findable DOI. (Learn more about [DOI States](doc:doi-states).)
