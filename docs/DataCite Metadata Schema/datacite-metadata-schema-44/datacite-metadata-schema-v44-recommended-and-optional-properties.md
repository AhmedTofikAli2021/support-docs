---
title: DataCite Metadata Schema v4.4 Recommended and Optional Properties
excerpt: ''
deprecated: false
hidden: false
metadata:
...
**Allowed values, examples, other constraints:** 
Example: 310607 (where 310607 is the classification code associated with the subject term
“Nanobiotechnology” in the ANZSRC Fields of Research subject scheme.
...
[block:code]
{
  "codes": [
    {
      "code": "<relatedIdentifier relatedIdentifierType=”ISSN”\nrelationType=”IsPublishedIn”>2213-1337</relatedIdentifier>",
      "language": "xml"
    }
  ]
}
...
[block:code]
{
  "codes": [
    {
      "code": "<relatedIdentifier relatedIdentifierType=\"DOI\"\nrelationType=\"IsObsoletedBy\">10.5438/0005\n</relatedIdentifier>",
      "language": "xml"
    }
  ]
}
...
## 19.4 awardTitle 
**Occurrence:** 0-1 
**Definition:** Information about a resource related to the one being registered, e.g., a journal or
book of which the article or chapter is part
**Allowed values, examples, other contraints:**
Example:
...
**Allowed values, examples, other contraints:**
Example:
- Use the controlled list values as stated in 10.a
...
**Allowed values, examples, other contraints:**
Example:
- Use the controlled list values as stated in 12.b
...
**Allowed values, examples, other contraints:**
Use the controlled list values as stated in 12.a.
...
Jemison, Mae; 
Foo Data
Center Note: The personal name, format should be:
family, given. 
Non- roman names may be transliterated according to the ALA-LC
schemas12.

#### 20.2.1.a nameType 
**Occurrence:**0-1 
**Definition:**The type of name Controlled List Values: Organizational
**Allowed values, examples, other contraints:**
Personal (default)
...
###  20.3.a titleType 
**Occurrence:**0-1 
**Definition:**Type of the related item title.
**Allowed values, examples, other contraints:**
Use this subproperty to add a subtitle, translation, or alternate title to the main title.
...
## 20.12 Contributor 
**Occurrence:**0-n
**Definition:**An institution or person identified as contributing to the development of the resource. If
multiple contributors are identified, this subproperty may be repeated for each contributor.
...
**Definition:**The type of contributor of the resource
**Allowed values, examples, other contraints:**
Use the controlled list values as stated in 7.a.


### 20.12.1 contributorName 
**Occurrence:**1 
**Definition:**The full name of the related item contributor. If Contributor is used, then contributorName is mandatory.
**Allowed values, examples, other contraints:**
Examples: Charpy, Antoine;Jemison, Mae; Foo DataCenter 
Note: The personal name, format should be: family, given. 
Non- roman names may be transliterated according to the ALA-LC schemas12.
...
### 20.12.3 familyName
**Occurrence:** 0-1 The surname or last name of the contributor
**Allowed values, examples, other contraints:**
Examples based on the 20.12.1 name : Charpy;Jemison