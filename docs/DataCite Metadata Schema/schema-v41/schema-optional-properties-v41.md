...
**Allowed values, examples, other constraints:** Free text
May be used to provide more information about the publication, release or collection date details, for example.
...
**Allowed values, examples, other constraints:** Free text. Use this property to indicate subsets of properties, as appropriate.
...
## 12.2 relationType
**Occurrence:** 1
**Definition: ** Description of the relationship of
the resource being registered (A) and the related resource (B).
...
- ISNI
- GRID
- Crossref Funder. The FundRef service is now called “[Open Funder Registry](https://www.crossref.org/services/funder-registry/)”  and Crossref Funder ID is the new name for a Fundref identifier.
- Other
