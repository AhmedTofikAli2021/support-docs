...
next:
  ...
  pages:
    - type: basic
      slug: schema-changes-software-citation-v41
      title: DataCite Metadata Schema v4.1 Changes in Support of Software Citation
---
The following are a set of standard values that may be used when mandatory property values are not available for various reasons.
[block:parameters]
{
  "data": {
    "h-0": "Code",
    ...
    "8-0": "(:tba)",
    "8-1": "to be assigned or announced later",
    "9-0": "(:etal)",
