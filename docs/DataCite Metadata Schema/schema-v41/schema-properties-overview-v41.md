---
title: DataCite Metadata Schema v4.1 Properties Overview
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  ...
  pages:
    - type: basic
      slug: schema-mandatory-properties-v41
      title: DataCite Metadata Schema v4.1 Mandatory Properties
---
# Overview

The properties of the DataCite Metadata Schema are presented in this section. More detailed descriptions of the properties, and their related sub-properties, are provided in [DataCite Schema Mandatory Properties](doc:schema-mandatory-properties-v41) and [DataCite Schema Recommended and Optional Metadata](doc:schema-optional-properties-v41). 
...
The [DataCite Schema Mandatory Properties](doc:schema-mandatory-properties-v41) provides a detailed description of the mandatory properties, which *must* be supplied with any initial metadata submission to DataCite, together with their sub-properties. **If one of the required properties is unavailable** , please use one of the standard (machine-recognizable) codes listed in [Standard Values for Unknown Information](doc:schema-values-unknown-information-v41). In [DataCite Schema Recommended and Optional Properties](doc:schema-optional-properties-v41), the Recommended and Optional properties are described in detail. For an example of how to make a submission in XML format, please see the [XML Metadata Examples](doc:schema-metadata-examples-v41) or the [DataCite Metadata Schema website](http://schema.datacite.org/).
