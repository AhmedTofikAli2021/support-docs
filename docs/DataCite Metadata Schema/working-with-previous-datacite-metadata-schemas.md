...
[/block]
The current version of the DataCite Metadata Schema is found at the [DataCite Metadata Schema website](https://schema.datacite.org). The current version is 4.1. 

The most recent version of the DataCite Metadata Schema is the preferred version of the schema for [DOI Fabrica](https://doi.datacite.org) and our [MDS API](http://mds.datacite.org), but many of the previous versions of the DataCite Metadata Schema are still valid.
[block:image]
{
  "images": [
    {
...
* DataCite Metadata Schema 2.2 (Released 1 Jul 2011)
  ...
  * [Examples](http://schema.datacite.org/meta/kernel-2.2/)
* DataCite Metadata Schema 2.1 (Released 28 Mar 2011)
  ...
  * [Example](http://schema.datacite.org/meta/kernel-2.1/)
[block:api-header]
{
  "type": "basic",
