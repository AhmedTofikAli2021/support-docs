---
title: Update Repository Settings (Consortium Leads and Consortium Organizations)
excerpt: ''
deprecated: false
hidden: false
metadata:
...
To modify the Repository settings, go to the Settings tab in the Repository dashboard. Select the Repository from the list of Repositories in order to view the appropriate Repository dashboard. Click the _Update Repository_ button in the upper right. 
