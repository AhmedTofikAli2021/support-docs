---
title: Delete a Repository (old version)
excerpt: ''
deprecated: false
hidden: true
link:
  new_tab: false
  url: https://support.datacite.org/docs/fabrica-delete-repository
metadata:
  title: ''
  description: ''
  robots: index
...
If the Repository has registered DOIs, the Member must first [transfer the DOIs](doc:transfer-dois-between-clients) to another Repository managed by the same Member.
