...
Old Repository [ID: XXXX.XXXX]
New Repository ID: [XXXX.XXXX]
Prefix: [10.xxxx]
Number of DOIs: [xxx]
...
The steps are the same as for Direct Members, but the Consortium Lead contacts [support@datacite.org](mailto:support@datacite.org) with the following information for all of the repositories corresponding to their Consortium Organizations.
