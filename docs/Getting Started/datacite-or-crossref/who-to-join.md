...
next:
  description: ''
---
One size fits all’ never quite works, does it? This is why there are different [DOI Registration Agencies](https://www.doi.org/RA_Coverage.html) to serve the needs of different communities, which are governed by those communities. Crossref and DataCite constitute two of these Registration Agencies, but we overlap more than most in our missions and our communities.
...
Crossref members are organizations who publish content, or register research grants. These include publishers, research institutions, university presses, societies and funders. In order to become a member, register content and deposit metadata and DOIs, you’ll need to meet the criteria set out in our governing [by-laws](https://www.crossref.org/board-and-governance/bylaws). Membership in Crossref is open to organizations that publish professional and scholarly materials and content. In addition, applicants should be able to meet the [terms and conditions](https://www.crossref.org/membership/terms) of membership. 
...
It’s [not just about ‘getting a DOI’.](https://www.crossref.org/education/why-crossref#00562) Crossref and DataCite have expertise and services that support and enhance the specific needs of our communities and how they work with their content. 

**Crossref [provides services](https://www.crossref.org/services/) like: 
**
[Reference Linking](https://www.crossref.org/services/reference-linking): Reference linking enables researchers to follow a link from the reference list to other full-text documents, helping them to make connections and discover new things.

[Cited-by](https://www.crossref.org/services/cited-by): Cited-by shows how work has been received by the wider community; displaying the number of times it has been cited, and linking to the citing content.

[Similarity Check](https://www.crossref.org/services/similarity-check): A service provided by Crossref and powered by iThenticate—Similarity Check provides editors with a user-friendly tool to help detect plagiarism.
...
[Link checker](doc:link-checker): Automatically checks your DOIs to make sure they are still resolving correctly. 

[Data metrics badge](doc:displaying-usage-and-citations-in-your-repository): Embed citation metrics for any DataCite DOI on your own website. 
...
The Center for Open Science (COS) provides a good example of a member who works with both of our organizations to meet the needs of their community:
...
If a persistent identifier for an object already exists, you should continue to use that identifier for the content and not reassign another identifier for that object under your own prefix. 

## Still not sure? 

We’ve created a [diagram](doc:datacite-or-crossref) to try to help you try to decide who to join, based on the workflow the content you work.