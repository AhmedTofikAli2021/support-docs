...
{
  "type": "info",
  "body": "The test system uses a test handle server. Test DOIs resolve via this test handle server. DOIs  created in the test system aren’t real and don’t resolve using the global handle system via https://doi.org. They look like this: https://handle.stage.datacite.org/10.17596/w76y-4s92"
}
[/block]
